...
def professor_registration_error(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail('MiddCourses Prof Registration', message,
                      settings.DEFAULT_FROM_EMAIL, ['dsilver@middlebury.edu'])
            return TemplateResponse(request, 'users/prof_reg_error_submitted.html',
