...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.prof_feedback'
        db.alter_column(u'reviews_review', 'prof_feedback', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Review.prof_help'
        db.alter_column(u'reviews_review', 'prof_help', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Review.prof_lecturing'
        db.alter_column(u'reviews_review', 'prof_lecturing', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Review.prof_leading'
        db.alter_column(u'reviews_review', 'prof_leading', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Review.prof_feedback'
        db.alter_column(u'reviews_review', 'prof_feedback', self.gf('django.db.models.fields.IntegerField')(max_length=1))

        # Changing field 'Review.prof_help'
        db.alter_column(u'reviews_review', 'prof_help', self.gf('django.db.models.fields.IntegerField')(max_length=1))

        # Changing field 'Review.prof_lecturing'
        db.alter_column(u'reviews_review', 'prof_lecturing', self.gf('django.db.models.fields.IntegerField')(max_length=1))

        # Changing field 'Review.prof_leading'
        db.alter_column(u'reviews_review', 'prof_leading', self.gf('django.db.models.fields.IntegerField')(max_length=1))
