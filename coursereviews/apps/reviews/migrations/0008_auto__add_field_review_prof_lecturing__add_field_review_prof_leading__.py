...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.prof_lecturing'
        db.add_column(u'reviews_review', 'prof_lecturing',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1),
                      keep_default=False)

        # Adding field 'Review.prof_leading'
        db.add_column(u'reviews_review', 'prof_leading',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1),
                      keep_default=False)

        # Adding field 'Review.prof_help'
        db.add_column(u'reviews_review', 'prof_help',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1),
                      keep_default=False)

        # Adding field 'Review.prof_feedback'
        db.add_column(u'reviews_review', 'prof_feedback',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.prof_lecturing'
        db.delete_column(u'reviews_review', 'prof_lecturing')

        # Deleting field 'Review.prof_leading'
        db.delete_column(u'reviews_review', 'prof_leading')

        # Deleting field 'Review.prof_help'
        db.delete_column(u'reviews_review', 'prof_help')

        # Deleting field 'Review.prof_feedback'
        db.delete_column(u'reviews_review', 'prof_feedback')
