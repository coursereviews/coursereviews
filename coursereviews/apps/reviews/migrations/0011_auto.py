...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field up_votes on 'Review'
        m2m_table_name = db.shorten_name(u'reviews_review_up_votes')
        ...
        # Adding M2M table for field down_votes on 'Review'
        m2m_table_name = db.shorten_name(u'reviews_review_down_votes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('review', models.ForeignKey(orm[u'reviews.review'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field up_votes on 'Review'
        db.delete_table(db.shorten_name(u'reviews_review_up_votes'))

        # Removing M2M table for field down_votes on 'Review'
        db.delete_table(db.shorten_name(u'reviews_review_down_votes'))
