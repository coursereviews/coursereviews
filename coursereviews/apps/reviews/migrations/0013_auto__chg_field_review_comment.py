...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reviews_review', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Review.comment'
        db.alter_column(u'reviews_review', 'comment', self.gf('django.db.models.fields.TextField')(default=''))
