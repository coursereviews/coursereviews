...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Professor.lookup'
        db.add_column(u'reviews_professor', 'lookup',
                      self.gf('django.db.models.fields.CharField')(default='Murray Dry', max_length=201),
                      keep_default=False)

        # Adding field 'Course.lookup'
        db.add_column(u'reviews_course', 'lookup',
                      self.gf('django.db.models.fields.CharField')(default='PSCI102 - American Political Regime', max_length=276),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Professor.lookup'
        db.delete_column(u'reviews_professor', 'lookup')

        # Deleting field 'Course.lookup'
        db.delete_column(u'reviews_course', 'lookup')
    ...
    models = {
        ...
        u'reviews.review': {
            ...
            'deserving': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '1'}),
