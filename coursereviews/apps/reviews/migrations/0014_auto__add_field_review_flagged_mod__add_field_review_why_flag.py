...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.flagged_mod'
        db.add_column(u'reviews_review', 'flagged_mod',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reviews_mod_flag', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Review.why_flag'
        db.add_column(u'reviews_review', 'why_flag',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.flagged_mod'
        db.delete_column(u'reviews_review', 'flagged_mod_id')

        # Deleting field 'Review.why_flag'
        db.delete_column(u'reviews_review', 'why_flag')
