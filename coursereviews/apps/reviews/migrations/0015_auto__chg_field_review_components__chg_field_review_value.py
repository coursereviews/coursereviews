...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.components'
        db.alter_column(u'reviews_review', 'components', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=21))

        # Changing field 'Review.value'
        db.alter_column(u'reviews_review', 'value', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=9))

    def backwards(self, orm):

        # Changing field 'Review.components'
        db.alter_column(u'reviews_review', 'components', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=19))
