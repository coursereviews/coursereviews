...
urlpatterns = patterns('',
                       ...
                       url(r'^register/$',
                           register,
                           {'backend': 'registration.backends.default.DefaultBackend', 'template_name': 'static_pages/homepage.html', 'extra_context': { 'tab': '#sign-up' }},
                           name='registration_register'),
                       url(r'^register/complete/$',
                           TemplateView.as_view(template_name='cr_registration/registration_complete.html'),
